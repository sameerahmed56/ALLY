            ...
            <View style={{...styles.Container,backgroundColor:colors.BACKGROUND,}}>
                ...
                <ScrollView>
                    ...
                    <View style={{...styles.Tile,backgroundColor:colors.TILE}}>
                        ...
                        <Text
                        style={{alignSelf:'center',marginBottom:10,color:'blue',borderBottomColor:'blue',borderBottomWidth:1}}
                        onPress={() => Linking.openURL(notificationData.goToLink)}
                        >
                            {notificationData.goToLink}
                        </Text>
                    </View>
